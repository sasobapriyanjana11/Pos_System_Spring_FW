...
public class WebAppRootConfig {
    ...
    public DataSource dataSource() {
        ...
        dmds.setUrl("jdbc:mysql://localhost:3306/pos_system_REST_API?createDatabaseIfNotExist=true");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("lk.ijse.gdse68.POS_System_REST_API.entity");
